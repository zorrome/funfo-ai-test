  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 md:p-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-slate-900">👤 用户信息登录与统计</h1>
          <p className="text-sm text-slate-500 mt-1">录入姓名、性别、年龄,并查看简单统计结果。</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
                <div className="text-xs text-slate-500 mb-1">👨 男</div>
                <div className="text-2xl font-bold text-blue-600">{stats.male_count}</div>
              </div>
              <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
                <div className="text-xs text-slate-500 mb-1">👩 女</div>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
              <div className="flex items-center justify-between mb-3">
                <h2 className="text-sm font-semibold text-slate-800">📊 性别统计</h2>
                <span className="text-xs text-slate-400">简单分布图</span>
              </div>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xs text-slate-400">支持编辑与删除</span>
              </div>
